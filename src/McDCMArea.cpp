...
: mcZMPAreaPtr_(mcZMPAreaPtr), mcComAreaPtr_(mcComAreaPtr)
{
...
bool McDCMArea::updateMcDCMArea()
{
  ...
  */
  ...
  pointsToInequalityMatrix<Eigen::Vector2d>(polygonVertices_, ieqConstraintBlocks_.G, ieqConstraintBlocks_.h,
